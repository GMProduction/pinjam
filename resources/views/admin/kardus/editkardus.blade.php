                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="namaKardus" name="nama" value="{{$produk->nama}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="tebal" name="tebal" value="{{$produk->tebal}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="panjang" name="panjang" value="{{$produk->panjang}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="lebar" name="lebar" value="{{$produk->lebar}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="tinggi" name="tinggi" value="{{$produk->tinggi}}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="minbeli" name="minimum" value="{{$produk->minimum}}"
                                                   class="form-control">
                                        </div>
                                    </div>
